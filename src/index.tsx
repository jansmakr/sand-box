  ...
  return c.render(
    <div>
      ...
      <header class="bg-white shadow-sm border-b">
            ...
            <div class="flex items-center">
              ...
              <div class="relative">
                <button id="desktop-menu-btn" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-lg whitespace-nowrap flex items-center transition-colors">
                  <i class="fas fa-bars mr-2"></i>메뉴
                </button>
                <div id="desktop-menu-dropdown" class="hidden absolute top-full right-0 mt-2 w-56 bg-white shadow-2xl rounded-xl border border-gray-200 py-2 z-50">
                  <a href="/facilities" class="block px-4 py-3 hover:bg-gray-50 text-gray-700 transition-colors">
                    <i class="fas fa-search-location text-purple-600 mr-2"></i>전국 시설 찾기
                  </a>
                  <a href="http://케어조아.shop" target="_blank" rel="noopener noreferrer" class="block px-4 py-3 hover:bg-gray-50 text-gray-700 transition-colors">
                    <i class="fas fa-calculator text-teal-600 mr-2"></i>요양비 계산
                  </a>
                  <a href="/integrated-care" class="block px-4 py-3 hover:bg-gray-50 text-gray-700 transition-colors">
                    <i class="fas fa-heart text-pink-600 mr-2"></i>통합돌봄 안내
                  </a>
                  <div class="border-t border-gray-200 my-2"></div>
                  <a href="#partner-section" class="block px-4 py-3 hover:bg-gray-50 text-gray-700 transition-colors">
                    <i class="fas fa-handshake text-gray-600 mr-2"></i>입점 신청
                  </a>
                  <a href="/family-care-register" class="block px-4 py-3 hover:bg-gray-50 text-gray-700 transition-colors">
                    <i class="fas fa-user-nurse text-green-600 mr-2"></i>가족간병 등록
                  </a>
                  <a href="/call-consultation" class="block px-4 py-3 hover:bg-gray-50 text-gray-700 transition-colors">
                    <i class="fas fa-phone-alt text-purple-600 mr-2"></i>전화상담
                  </a>
                  <a href="/manager-consultation" class="block px-4 py-3 hover:bg-gray-50 text-gray-400 opacity-60 cursor-not-allowed">
                    <i class="fas fa-user-tie mr-2"></i>매니저 상담 <span class="text-xs">(준비중)</span>
                  </a>
                  <a href="/membership" class="block px-4 py-3 hover:bg-gray-50 text-gray-400 opacity-60 cursor-not-allowed">
                    <i class="fas fa-crown mr-2"></i>멤버십 <span class="text-xs">(준비중)</span>
                  </a>
                </div>
              </div>
              <a href="/login" class="bg-teal-600 text-white hover:bg-teal-700 px-4 py-2 rounded-lg whitespace-nowrap transition-colors">
                <i class="fas fa-sign-in-alt mr-1"></i>로그인
              </a>
              <a href="/signup" class="bg-blue-600 text-white hover:bg-blue-700 px-4 py-2 rounded-lg whitespace-nowrap transition-colors">
        ...
        </div><div id="mobile-menu" class="hidden md:hidden bg-white border-t max-h-[80vh] overflow-y-auto">
          <nav class="px-4 py-3 space-y-2">
            <a href="/login" class="block bg-teal-600 text-white hover:bg-teal-700 px-4 py-3 rounded-lg text-center font-medium">
              <i class="fas fa-sign-in-alt mr-2"></i>로그인
            </a>
            <a href="/signup" class="block bg-blue-600 text-white hover:bg-blue-700 px-4 py-3 rounded-lg text-center font-medium">
              <i class="fas fa-user-plus mr-2"></i>회원가입
            </a>
            <div class="border-t border-gray-200 my-2"></div>
            <a href="/facilities" class="block bg-purple-100 text-purple-700 hover:bg-purple-200 px-4 py-3 rounded-lg text-center font-medium">
              <i class="fas fa-search-location mr-2"></i>전국 시설 찾기
            </a>
            <a href="http://케어조아.shop" target="_blank" rel="noopener noreferrer" class="block bg-teal-100 text-teal-700 hover:bg-teal-200 px-4 py-3 rounded-lg text-center font-medium">
              <i class="fas fa-calculator mr-2"></i>요양비 계산
            </a>
            <a href="/integrated-care" class="block bg-pink-100 text-pink-700 hover:bg-pink-200 px-4 py-3 rounded-lg text-center font-medium">
              <i class="fas fa-heart mr-2"></i>통합돌봄 안내
            </a>
            <a href="#partner-section" class="block bg-gray-100 text-gray-700 hover:bg-gray-200 px-4 py-3 rounded-lg text-center font-medium">
              <i class="fas fa-handshake mr-2"></i>입점 신청
            </a>
            <a href="/family-care-register" class="block bg-green-100 text-green-700 hover:bg-green-200 px-4 py-3 rounded-lg text-center font-medium">
              <i class="fas fa-user-nurse mr-2"></i>가족간병 등록
            </a>
            <a href="/call-consultation" class="block bg-purple-100 text-purple-700 hover:bg-purple-200 px-4 py-3 rounded-lg text-center font-medium">
      ...
      <section class="py-12 sm:py-14 md:py-16 bg-gradient-to-b from-white to-gray-50">
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
          {/* 4개 핵심 버튼 - 히어로 이미지 스타일 */}
          <div class="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 mb-8" id="main-action-buttons">
                {/* 1. 간편검색 - 파란색 3D 버튼 */}
                <a href="/quote-simple"
                   class="group relative flex flex-col items-center justify-center bg-gradient-to-b from-blue-400 via-blue-500 to-blue-600 hover:from-blue-500 hover:via-blue-600 hover:to-blue-700 py-10 sm:py-12 md:py-14 px-4 sm:px-6 rounded-3xl shadow-[0_8px_20px_rgba(59,130,246,0.5)] hover:shadow-[0_12px_30px_rgba(59,130,246,0.6)] transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 min-h-[180px] sm:min-h-[200px] md:min-h-[220px] border-t-4 border-blue-300">
                  <div class="mb-4 sm:mb-5 bg-white bg-opacity-20 rounded-2xl p-4 sm:p-5 transform group-hover:scale-110 transition-transform duration-300">
                    <i class="fas fa-calculator text-6xl sm:text-7xl md:text-8xl text-white drop-shadow-2xl"></i>
                  </div>
                  <h3 class="font-black text-white text-xl sm:text-2xl md:text-3xl text-center mb-1 drop-shadow-lg">간편검색</h3>
                  <p class="text-blue-50 text-xs sm:text-sm font-semibold text-center">빠른 매칭 확인</p>
                </a>

                {/* 2. 상세검색 - 초록색 3D 버튼 */}
                <a href="/quote-request"
                   class="group relative flex flex-col items-center justify-center bg-gradient-to-b from-green-400 via-green-500 to-green-600 hover:from-green-500 hover:via-green-600 hover:to-green-700 py-10 sm:py-12 md:py-14 px-4 sm:px-6 rounded-3xl shadow-[0_8px_20px_rgba(34,197,94,0.5)] hover:shadow-[0_12px_30px_rgba(34,197,94,0.6)] transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 min-h-[180px] sm:min-h-[200px] md:min-h-[220px] border-t-4 border-green-300">
                  <div class="mb-4 sm:mb-5 bg-white bg-opacity-20 rounded-2xl p-4 sm:p-5 transform group-hover:scale-110 transition-transform duration-300">
                    <i class="fas fa-file-alt text-6xl sm:text-7xl md:text-8xl text-white drop-shadow-2xl"></i>
                  </div>
                  <h3 class="font-black text-white text-xl sm:text-2xl md:text-3xl text-center mb-1 drop-shadow-lg">상세검색</h3>
                  <p class="text-green-50 text-xs sm:text-sm font-semibold text-center">맞춤형 요양시설 추천</p>
                </a>

                {/* 3. 생생후기 - 노란색 3D 버튼 */}
                <a href="/reviews"
                   class="group relative flex flex-col items-center justify-center bg-gradient-to-b from-yellow-400 via-yellow-500 to-orange-500 hover:from-yellow-500 hover:via-yellow-600 hover:to-orange-600 py-10 sm:py-12 md:py-14 px-4 sm:px-6 rounded-3xl shadow-[0_8px_20px_rgba(234,179,8,0.5)] hover:shadow-[0_12px_30px_rgba(234,179,8,0.6)] transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 min-h-[180px] sm:min-h-[200px] md:min-h-[220px] border-t-4 border-yellow-300">
                  <div class="mb-4 sm:mb-5 bg-white bg-opacity-20 rounded-2xl p-4 sm:p-5 transform group-hover:scale-110 transition-transform duration-300">
                    <i class="fas fa-comments text-6xl sm:text-7xl md:text-8xl text-white drop-shadow-2xl"></i>
                  </div>
                  <h3 class="font-black text-white text-xl sm:text-2xl md:text-3xl text-center mb-1 drop-shadow-lg">생생후기</h3>
                  <p class="text-yellow-50 text-xs sm:text-sm font-semibold text-center">진솔한 사용자 평가</p>
                </a>

                {/* 4. 전문상담 - 분홍색 3D 버튼 */}
                <a href="/call-consultation"
                   class="group relative flex flex-col items-center justify-center bg-gradient-to-b from-pink-400 via-pink-500 to-pink-600 hover:from-pink-500 hover:via-pink-600 hover:to-pink-700 py-10 sm:py-12 md:py-14 px-4 sm:px-6 rounded-3xl shadow-[0_8px_20px_rgba(236,72,153,0.5)] hover:shadow-[0_12px_30px_rgba(236,72,153,0.6)] transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 min-h-[180px] sm:min-h-[200px] md:min-h-[220px] border-t-4 border-pink-300">
                  <div class="mb-4 sm:mb-5 bg-white bg-opacity-20 rounded-2xl p-4 sm:p-5 transform group-hover:scale-110 transition-transform duration-300">
                    <i class="fas fa-headset text-6xl sm:text-7xl md:text-8xl text-white drop-shadow-2xl"></i>
                  </div>
                  <h3 class="font-black text-white text-xl sm:text-2xl md:text-3xl text-center mb-1 drop-shadow-lg">전문상담</h3>
                  <p class="text-pink-50 text-xs sm:text-sm font-semibold text-center">전문가 맞춤 상담 지원</p>
                </a>
              ...
              {/* 특허 배너 - 모바일 최적화 */}
              <div class="bg-gradient-to-r from-indigo-600 to-purple-600 px-4 py-3 rounded-xl shadow-lg mb-6">
                <div class="flex items-center justify-center gap-2">
                  <i class="fas fa-certificate text-yellow-300 text-lg"></i>
                  <div class="text-white text-center">
                    <div class="font-bold text-base sm:text-lg">특허 기반 AI 매칭</div>
                    <div class="text-xs opacity-90">특허번호: 10-2025-0058040</div>
                  </div>
                </div>
              </div>
              ...
              <div class="flex flex-wrap items-center justify-center gap-2 sm:gap-3 text-xs sm:text-sm">
                <div class="bg-white px-3 py-1.5 rounded-full shadow-sm">
                  <i class="fas fa-users text-blue-500 mr-1"></i>
                  <span class="font-semibold text-gray-700">월 10만+ 이용</span>
                </div>
                <div class="bg-white px-3 py-1.5 rounded-full shadow-sm">
                  <i class="fas fa-building text-teal-500 mr-1"></i>
                  <span class="font-semibold text-gray-700">3,000+ 시설</span>
                </div>
                <div class="bg-white px-3 py-1.5 rounded-full shadow-sm">
                  <i class="fas fa-star text-yellow-500 mr-1"></i>
                  <span class="font-semibold text-gray-700">평균 4.5점</span>
                </div>
              </div>
            </div>
          </section>
      ...
      <div class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-2 py-2 z-50 md:hidden shadow-lg">
        <div class="flex justify-around items-center max-w-md mx-auto">
          <a href="/facilities" class="flex flex-col items-center py-1.5 bg-purple-600 text-white rounded-lg px-2 shadow-md active:scale-95 transition-transform">
            <i class="fas fa-search-location text-sm mb-0.5"></i>
            <span class="text-[9px] font-medium">전국시설</span>
          </a>
          <a href="/call-consultation" class="flex flex-col items-center py-1.5 bg-green-600 text-white rounded-lg px-2 shadow-md active:scale-95 transition-transform">
            <i class="fas fa-phone-alt text-sm mb-0.5"></i>
            <span class="text-[9px] font-medium">전화상담</span>
          </a>
          <a href="/family-care-register" class="flex flex-col items-center py-1.5 bg-teal-600 text-white rounded-lg px-2 shadow-md active:scale-95 transition-transform">
            <i class="fas fa-heart text-sm mb-0.5"></i>
            <span class="text-[9px] font-medium">가족간병</span>
          </a>
          <a href="#partner-section" class="flex flex-col items-center py-1.5 bg-gray-600 text-white rounded-lg px-2 shadow-md active:scale-95 transition-transform">
            <i class="fas fa-handshake text-sm mb-0.5"></i>
            <span class="text-[9px] font-medium">입점신청</span>
          </a>
        </div>
      </div>
      ...
      <section class="py-12 sm:py-16 bg-white">
        <div class="max-w-6xl mx-auto px-4">
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            <div class="text-center p-4 sm:p-6 bg-blue-50 rounded-xl">
              <div class="w-16 h-16 sm:w-20 sm:h-20 bg-blue-500 rounded-xl flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <i class="fas fa-calculator text-2xl sm:text-3xl text-white"></i>
              </div>
              <h4 class="text-base sm:text-lg font-bold mb-1 sm:mb-2 text-gray-800">실시간 견적</h4>
              <p class="text-gray-600 text-xs sm:text-sm">즉시 확인</p>
            </div>
            
            <div class="text-center p-4 sm:p-6 bg-teal-50 rounded-xl">
              <div class="w-16 h-16 sm:w-20 sm:h-20 bg-teal-500 rounded-xl flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <i class="fas fa-hospital text-2xl sm:text-3xl text-white"></i>
              </div>
              <h4 class="text-base sm:text-lg font-bold mb-1 sm:mb-2 text-gray-800">검증된 시설</h4>
              <p class="text-gray-600 text-xs sm:text-sm">정부 인증</p>
            </div>
            
            <div class="text-center p-4 sm:p-6 bg-purple-50 rounded-xl">
              <div class="w-16 h-16 sm:w-20 sm:h-20 bg-purple-500 rounded-xl flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <i class="fas fa-user-md text-2xl sm:text-3xl text-white"></i>
              </div>
              <h4 class="text-base sm:text-lg font-bold mb-1 sm:mb-2 text-gray-800">전문 상담</h4>
              <p class="text-gray-600 text-xs sm:text-sm">맞춤 상담</p>
            </div>
            
            <div class="text-center p-4 sm:p-6 bg-pink-50 rounded-xl">
              <div class="w-16 h-16 sm:w-20 sm:h-20 bg-pink-500 rounded-xl flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <i class="fas fa-heart text-2xl sm:text-3xl text-white"></i>
              </div>
              <h4 class="text-base sm:text-lg font-bold mb-1 sm:mb-2 text-gray-800">가족같은 마음</h4>
              <p class="text-gray-600 text-xs sm:text-sm">끝까지 함께</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* 간단한 3단계 - 모바일 최적화 */}
      <section class="py-12 sm:py-16 bg-gradient-to-br from-gray-50 to-teal-50">
        <div class="max-w-6xl mx-auto px-4">
          <div class="text-center mb-8 sm:mb-12">
            <h3 class="text-2xl sm:text-3xl font-bold text-gray-900">
          ...
          <div class="grid grid-cols-3 gap-4 sm:gap-8">
            <div class="text-center">
              ...
              <h4 class="text-sm sm:text-lg font-bold mb-1 sm:mb-2 text-gray-800">정보 입력</h4>
              <p class="text-gray-600 text-xs sm:text-sm">기본 정보</p>
            </div>
            ...
            <div class="text-center">
              ...
              <h4 class="text-sm sm:text-lg font-bold mb-1 sm:mb-2 text-gray-800">견적 비교</h4>
              <p class="text-gray-600 text-xs sm:text-sm">실시간 매칭</p>
            </div>
            ...
            <div class="text-center">
              ...
              <h4 class="text-sm sm:text-lg font-bold mb-1 sm:mb-2 text-gray-800">전문 상담</h4>
              <p class="text-gray-600 text-xs sm:text-sm">1:1 맞춤</p>
            </div>
          </div>
        </div>
