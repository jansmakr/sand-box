...
app.get('/', (c) => {
  ...
  const authButton = session 
    ? `<a href="/my-page" class="bg-teal-600 text-white hover:bg-teal-700 px-4 py-2 rounded-lg flex items-center ml-2">
         <i class="fas fa-user mr-2"></i>마이페이지
       </a>`
    : `<a href="/login" class="bg-teal-600 text-white hover:bg-teal-700 px-4 py-2 rounded-lg flex items-center ml-2">
         <i class="fas fa-sign-in-alt mr-2"></i>로그인
       </a>`
  
  const mobileAuthButton = session
    ? `<a href="/my-page" class="bg-teal-600 text-white hover:bg-teal-700 px-3 py-2 rounded-lg text-sm">
         <i class="fas fa-user mr-1"></i>마이페이지
       </a>`
    : `<a href="/login" class="bg-teal-600 text-white hover:bg-teal-700 px-3 py-2 rounded-lg text-sm">
    ...
    <div>
      ...
      <div class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 shadow-lg z-50 md:hidden" style="padding-bottom: env(safe-area-inset-bottom);">
        <div class="flex justify-around items-center py-2 px-1">
          ...
          <a href="/my-page" class="flex flex-col items-center py-2 px-2 hover:bg-gray-50 rounded-lg transition-colors min-w-0 flex-1">
            <div class="text-xl mb-1">👤</div>
            ...
            <div class="space-y-6 md:space-y-8">
              ...
              <div class="flex flex-col gap-3 md:gap-4 mb-8">
                ...
                <div class="grid grid-cols-2 gap-3 md:gap-4 mt-3 md:mt-4">
                  {/* 간병인 구인구직 */}
                  <a href="https://cafe.naver.com/f-e/cafes/30901226/menus/159" 
                     target="_blank"
                     rel="noopener noreferrer"
                     class="flex flex-col items-center justify-center bg-gradient-to-br from-orange-500 to-red-500 text-white p-4 md:p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                    <span class="text-3xl md:text-4xl mb-2">👨‍⚕️</span>
                    <span class="text-xs md:text-base font-bold text-center">간병인 구인구직</span>
                  </a>

                  {/* 동행서비스 구인구직 */}
                  <a href="https://cafe.naver.com/f-e/cafes/30901226/menus/198" 
                     target="_blank"
                     rel="noopener noreferrer"
                     class="flex flex-col items-center justify-center bg-gradient-to-br from-blue-500 to-indigo-600 text-white p-4 md:p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                    <span class="text-3xl md:text-4xl mb-2">🤝</span>
                    <span class="text-xs md:text-base font-bold text-center">동행서비스 구인구직</span>
                  </a>
                </div>
              </div>
